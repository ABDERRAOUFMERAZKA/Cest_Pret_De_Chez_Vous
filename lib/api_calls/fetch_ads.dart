...
class FetchAds {
  static List<Ad> loadHome({@required String locationAsNumber}) {
    return listOfAds.where((Ad ad) => ad.locationAsNumber == locationAsNumber);
  }

  static List<Ad> search(
      {@required Category category,
      @required List<String> keyWords,
      @required String locationAsNumber}) {
    return listOfAds.where((Ad ad) =>
