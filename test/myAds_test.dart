...
import 'package:cest_pret_de_chez_vous/src/display_ads/view/my_ads.dart';
...
void main() {
  ...
  testWidgets('MyAds widget test', (WidgetTester tester) async {
    MyAd page = MyAd();
    ...
    expect(find.text('My Ad Screen'), findsOneWidget);
  });
}
